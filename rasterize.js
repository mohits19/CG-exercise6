...
function renderTriangles() {
    ...
    mat4.multiply(inputTriangles[0].mMatrix,
                  mat4.fromTranslation(mat4.create(),vec3.fromValues(-0.75,-0.25,0)),
	...
	var setCenter = vec3.fromValues(.25,.25,0);  // center coords of tri set 
    ...
    mat4.multiply(inputTriangles[1].mMatrix,
                  ...
                  inputTriangles[1].mMatrix); // rotate 90 degs
	mat4.multiply(inputTriangles[1].mMatrix,
                  mat4.fromTranslation(mat4.create(),vec3.fromValues(-0.25,-0.5,0)),
